-- =============================================================================
-- Lean Gain HQ · consolidated Supabase / Postgres schema
-- -----------------------------------------------------------------------------
-- Mirrors `supabase/migrations/20260503120000_initial_schema.sql` for quick
-- reference, onboarding, or a one-shot apply in SQL Editor on an EMPTY project.
--
-- Prefer versioned migrations for production drift. Requires `auth.users` (Auth)
-- plus permission to attach triggers on `auth.users`.
--
-- Sections: enums & tables • handle_new_user() • auth trigger • RLS policies
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Bootstrap new auth users (callable manually via bootstrap_lean_tracker_user)
-- ---------------------------------------------------------------------------
